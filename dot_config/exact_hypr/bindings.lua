...
o.bind("SUPER + L", "Lock screen", "icyleaf-system-lock")
...
o.bind("SUPER + comma", "Bitwarden", function()
  hl.dispatch(hl.dsp.exec_cmd("omarchy-shell shell toggle icyleaf.bitwarden"))
end)
