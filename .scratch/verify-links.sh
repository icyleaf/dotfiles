...
# Run system installer if exists
if [ -f config/linux/system/install.sh ]; then
  bash config/linux/system/install.sh
fi

# Run walker installer
if [ -f config/linux/walker/install.sh ]; then
  bash config/linux/walker/install.sh
fi

# Run waybar installer
if [ -f config/linux/waybar/install.sh ]; then
  bash config/linux/waybar/install.sh
fi

# Run plymouth installer
if [ -f config/linux/plymouth/install.sh ]; then
  bash config/linux/plymouth/install.sh
fi
